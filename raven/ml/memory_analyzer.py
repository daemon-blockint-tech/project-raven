...
class MemoryAnalyzer:
    ...
    def analyze_crash(
        self, crash_log: str, binary_path: str
    ) -> Optional[MemoryVulnerability]:
    ...
    def run_with_asan(self, binary_path: str, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            result = subprocess.run(
                [safe_path] + args, env=env, capture_output=True, text=True, timeout=30
            )
            ...
            return {
                ...
                or "runtime error" in result.stderr.lower(),
            }
    ...
    def run_with_valgrind(self, binary_path: str, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "stdout": result.stdout,
                "stderr": result.stderr,
                "has_leaks": "definitely lost" in result.stderr
                or "indirectly lost" in result.stderr,
            }
    ...
    def validate_vulnerability(
        self, vuln: MemoryVulnerability, binary_path: str
    ) -> bool:
