...
class SequenceAnalyzer:
    ...
    def _find_pattern_match(self, sequence: List[str], pattern: List[str], 
                           pattern_name: str) -> Optional[SequenceMatch]:
    ...
    def detect_anomalous_sequences(self, sequences: List[List[str]]) -> List[Dict[str, Any]]:
    ...
    def extract_patterns_from_sequences(self, sequences: List[List[str]], 
                                      min_support: float = 0.1) -> List[List[str]]:
