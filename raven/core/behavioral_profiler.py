...
class BehavioralProfiler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.deviation_threshold = config.get("deviation_threshold", 2.0)  # Standard deviations
        
    def create_profile(self, entity_id: str, entity_type: str, 
    ...
    def update_profile(self, entity_id: str, new_data: List[Dict[str, Any]]) -> BehaviorProfile:
    ...
    def check_deviation(self, entity_id: str, current_data: Dict[str, Any]) -> List[BehaviorDeviation]:
    ...
    def _calculate_baseline(self, data: List[Dict[str, Any]]) -> Dict[str, Dict[str, float]]:
    ...
    def _create_deviation(self, entity_id: str, feature: str, 
                         baseline: float, observed: float, score: float) -> BehaviorDeviation:
