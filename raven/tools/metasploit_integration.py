...
class MetasploitIntegration:
    ...
    def connect(self, host: str = "localhost", port: int = 55553,
               user: str = "msf", password: str = "") -> bool:
    ...
    def exploit(self, target: str, exploit_module: str,
                options: Dict[str, Any]) -> MetasploitResult:
