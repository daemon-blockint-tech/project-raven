...
\begin{table}[tb]
  ...
  \begin{tabularx}{\columnwidth}{@{}YCCCC@{}}
    ...
    Single‑stage Single‑host \includegraphics[width=1.5cm]{figures/background/stages/single.png}&
    ...
    \midrule
    Multistage Single‑host \includegraphics[width=2cm]{figures/background/stages/multi_stage.png} &
    ...
    \midrule
    Multistage Multi‑host \includegraphics[width=3cm]{figures/background/stages/multi_host.png} &
      \abbrcite{MSF}{metasploit} &
      ...
      \\
    \midrule
     & Legend  &  \includegraphics[width=3cm]{figures/background/stages/legend.png} &   
  \end{tabularx}
  }%
\end{table}
