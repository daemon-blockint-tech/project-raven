...
\input{figures/table_statistics}
\input{figures/table_crash_types}
\include{figures/table_projects}
...
\begin{figure}[H]
    \centering
    \rbtlframe{\includegraphics[width=0.5\linewidth]{figures/poc_len_human.pdf}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \rbtlframe{\includegraphics[width=\linewidth]{figures/pre_post_cutoff/pre_post_dist_gpt-4.1.pdf}}
        \caption{\rbtl{\gptiv/o4-mini, knowledge cutoff: Jun 1, 2024}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \rbtlframe{\includegraphics[width=\linewidth]{figures/pre_post_cutoff/pre_post_dist_gpt-5.pdf}}
        \caption{\rbtl{\gptv, knowledge cutoff: Sep 30, 2024}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.32\textwidth}
        \centering
        \rbtlframe{\includegraphics[width=\linewidth]{figures/pre_post_cutoff/pre_post_dist_sonnet-3.7.pdf}}
...
\begin{figure}[H]
    \centering
    \rbtlframe{\includegraphics[width=\linewidth]{figures/different_models_resampling.pdf}}
...
\begin{figure}[H]
    \centering
    \rbtlframe{\includegraphics[width=0.5\linewidth]{figures/different_agents_resampling.pdf}}
...
\input{figures/raw_traces/early_termination}
\input{figures/raw_traces/long_plaintext}
\input{figures/raw_traces/grep_ls_find}
\input{figures/raw_traces/success_python}
\input{figures/raw_traces/fail_compile_python}
% \input{figures/raw_traces/openhands_arvo_10400_ds}
\input{figures/raw_traces/arvo_56150_claude4}
\input{figures/raw_traces/arvo_56150_enigma}
