...
\begin{wrapfigure}{r}{.52\textwidth}
    \centering
    \vspace{-4mm}
    \rbtlframe{\includegraphics[width=\linewidth]{figures/different_models.pdf}}
    \vspace{-6mm}
...
\begin{wrapfigure}[10]{r}{.4\textwidth}
    \vspace{-4.2mm}
    \centering
    \rbtlframe{\includegraphics[width=\linewidth]{figures/thinking_vs_nonthinking.pdf}}
    \vspace{-5.5mm}
...
\begin{wrapfigure}{r}{.35\textwidth}
    \vspace{-4mm}
    \centering
    \rbtlframe{\includegraphics[width=\linewidth]{figures/different_agents.pdf}}
    \vspace{-6mm}
...
\begin{wrapfigure}[11]{r}{.35\textwidth}
    \centering
    \vspace{-4mm}
    \rbtlframe{\includegraphics[width=\linewidth]{figures/claude_sr_vs_gt_poc_len.pdf}}
    \vspace{-5.5mm}
